...
<html>
    ...
    <title><Bob's JSP</title>
     <style type="text/css">
        body {
            color: #000000;
            background-color: #BEA9EP;
...
<table>
    <tr>
            ...
            <table width="100%" border="1" cellspacing="0" cellpadding="3" bordercolor="#000000">
                <tr>
                    <td bgcolor="#D2A41C" bordercolor="#000000" align="left" nowrap>
                        <font face="Verdana" size="+1"><i>Hey, Administration</i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font>
                    </td>
                </tr>
                <tr>
        ...
        <!-- Body -->
        <td align="left" valign="top">
            <p><center><b>Hey Bob, if you're seeing this page via a web browser, it means you've setup Tomcat successfully. Congratulations!</b></center></p>
